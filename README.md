...
### [1.2 Създаване на MVC проект в решението](https://github.com/vakovsky/11/blob/main/mvc/docs/projects.pdf)
### [1.3 Структура на MVVM проект в решението](https://github.com/vakovsky/11/blob/main/mvc/docs/projects.pdf)
